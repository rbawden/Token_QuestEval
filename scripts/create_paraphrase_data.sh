...
if [ ! -f $maindir/data/paraphrase/parabank1.1perexample.threshold0.7.tsv.gz ]; then
    ...
    python  $maindir/scripts/get_one_per_example.py $maindir/data/paraphrase/parabank1.tsv \
	    $maindir/data/paraphrase/parabank1.meta 1 \
...
if [ ! -f $maindir/data/paraphrase/parabank1.threshold0.7.detok.jsonl ]; then
    echo "Creating masked examples and outputting to $maindir/data/paraphrase/parabank1.threshold0.7.detok.jsonl..."
	...
	| python -u $maindir/scripts/create_dataset.py --hyp_lang 'en' --ref_lang 'en' \
		 > $maindir/data/paraphrase/parabank1.threshold0.7.detok.jsonl
fi
...
if [ ! -f $maindir/data/paraphrase/parabank1-parts/parabank1.threshold0.7.detok.jsonl.part-1 ]; then
    echo "Splitting data into smaller parts: parabank1.threshold0.7.detok.jsonl.part-{0,1,2...}..."
    split -l 250000 -d -a 3 $maindir/data/paraphrase/parabank1.threshold0.7.detok.jsonl \
	  $maindir/data/paraphrase/parabank1-parts/parabank1.threshold0.7.detok.jsonl.part-
...
if [ ! -f $maindir/data/paraphrase/parabank2.jsonl ]; then
    echo "Creating masked examples and outputting to $maindir/data/paraphrase/parabank2.jsonl..."
    zcat $maindir/data/paraphrase/parabank2.1perexample.tsv.gz \
	| python -u $maindir/scripts/create_dataset.py --hyp_lang 'en' --ref_lang 'en' \
		 > $maindir/data/paraphrase/parabank2.jsonl
fi
...
if [ ! -f $maindir/data/paraphrase/parabank2-parts/parabank2.jsonl.part-1 ]; then
    echo "Splitting data into smaller parts: parabank.threshold0.7.detok.jsonl.part-{0,1,2...}..."
    split -l 250000 -d -a 3 $maindir/data/paraphrase/parabank2.jsonl \
          $maindir/data/paraphrase/parabank2-parts/parabank2.jsonl.part-
    # rename for consistency
